...
class Header extends Component<IProps> {
    ...
    render() {
        const menuList = <ul>
            ...
            <li><Link to="/SampleServices">Home</Link></li>
        ...
        const networkName = (typeof NETWORKS[this.props.chainId] !== 'undefined' && typeof NETWORKS[this.props.chainId].name !== 'undefined') ?
